exports.queryList = {
  GET_STORE_LIST_QUERY:
    "SELECT STORE_ID, STORE_NAME, STORE_CODE, CREATED_ON, CREATED_BY, ADDRESS FROM BMS.STORE",
  ...
  GET_BOOK_DETAILS_QUERY: `SELECT BOOK_ID, BOOK_TITLE, BOOK_DESCRIPTION, BOOK_AUTHOR, BOOK_PUBLISHER, BOOK_PAGES, book.STORE_CODE,STORE.STORE_NAME ,STORE.ADDRESS 
                            FROM BMS.BOOK
  ...
  GET_USER_LIST_QUERY: `SELECT USER_ID, USERNAME, PASSWORD, EMAIL, FULL_NAME, USER_TYPE_CODE, CREATED_ON, CREATED_BY
                          FROM BMS.APP_USER`,

  SAVE_USER_QUERY: `INSERT INTO BMS.APP_USER(USERNAME, PASSWORD, EMAIL, FULL_NAME, USER_TYPE_CODE, CREATED_ON, CREATED_BY)
                      VALUES($1,$2 ,$3 ,$4 ,$5 ,$6,$7) `,

  IS_USER_EXIST_QUERY: `SELECT COUNT(USER_ID)
                         FROM BMS.APP_USER
                         WHERE LOWER(USERNAME)=LOWER($1) OR LOWER(EMAIL)=LOWER($2)`,

  LOGIN_QUERY: `SELECT USER_ID, USERNAME, PASSWORD, EMAIL, FULL_NAME, USER_TYPE_CODE,ACTIVE
                 FROM BMS.APP_USER
